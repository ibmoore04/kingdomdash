    ...
    <div className="bg-white text-neutral-900 overflow-x-hidden">
      ...
      <section className="border-b border-neutral-100 bg-neutral-50/70 py-6">
        <PageContainer>
          ...
          {/* Personal Market Shopper Banner (Responsive for Large & Small Screens) */}
          <div className="mt-5 rounded-2xl border border-primary/25 bg-gradient-to-r from-primary/[0.06] via-emerald-500/[0.03] to-white p-4 sm:p-5 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 shadow-2xs">
            <div className="flex items-start gap-3.5 text-left">
              ...
              <div className="space-y-1">
                <div className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider bg-primary/10 text-primary">
                  ...
                  <span>Direct Market Concierge</span>
                </div>
                <h3 className="text-sm sm:text-base font-bold text-neutral-900 leading-tight">
                  Prefer a custom market run to Oke-Aje or Ita Osu?
                </h3>
                <p className="text-xs text-neutral-600 leading-relaxed max-w-2xl">
                  Send a dedicated personal shopper with your exact grocery checklist, custom budget cap, and real-time WhatsApp price verification.
                </p>
              </div>
            </div>
            <Button
