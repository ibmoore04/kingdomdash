...
const HOW_IT_WORKS = [
  ...
  },
  {
    ...
    description: 'A verified dispatch rider is assigned to pick up your parcel in 30–45 minutes.',
  },
  {
    step: '03',
    icon: CheckCircle2,
    title: 'Safe Handover',
    description: 'Track the delivery in real-time until safe handover to your recipient.',
  },
]
...
function buildWhatsAppMessage(form: BookingForm, orderId?: string | null): string {
  const lines = [
    `*KingdomDash Courier Booking Request*`,
    orderId ? `Tracking ID: ${orderId}` : '',
    ``,
    `*Sender*`,
...
export default function CourierPage() {
  useSeo({
    title: 'Courier Dispatch in Ijebu-Ode — Same-Day Parcel & Document Delivery',
    description: `Fast, dependable same-day courier dispatch and package delivery across Ijebu-Ode, Ogun State. Verified dispatch riders, live GPS tracking, and transparent distance pricing.`,
    keywords: 'Courier Dispatch in Ijebu-Ode, dispatch rider Ijebu-Ode, parcel delivery Ogun State, same day delivery Nigeria, package dispatch',
    schema: getLocalBusinessSchema('courier'),
  })
