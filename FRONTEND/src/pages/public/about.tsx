...
// Authentic local operational focus
      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-neutral-50/70 border-t border-neutral-200/60">
        <PageContainer>
          <div className="text-center max-w-2xl mx-auto mb-12 sm:mb-16 space-y-2">
            ...
            <p className="text-sm sm:text-base text-neutral-600 leading-relaxed">
              We don&apos;t just promise delivery; we have built the physical infrastructure, local merchant partnerships, and technology to make every order reliable.
            </p>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:gap-8">
            {OPERATIONAL_PILLARS.map((pillar) => {
              ...
              return (
                <div
                  key={pillar.title}
                  className="flex flex-col sm:flex-row items-start gap-5 p-6 sm:p-7 rounded-2xl border border-neutral-200/80 bg-white shadow-xs hover:border-primary/30 hover:shadow-md transition-all"
                >
                  <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-red-50 text-primary">
                    <Icon className="h-6 w-6" aria-hidden="true" />
                  </div>
                  <div className="space-y-1.5 flex-1">
                    <h3 className="text-base sm:text-lg font-bold text-neutral-900">{pillar.title}</h3>
