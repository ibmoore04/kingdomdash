      ...
      <section className="py-16 sm:py-20 lg:py-24 bg-neutral-50/60 border-t border-neutral-100">
        <PageContainer>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Card 1: Careful Fresh Store Picking */}
            <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-xs flex flex-col justify-between space-y-4">
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-base sm:text-lg font-bold text-neutral-900">
                    Careful Fresh Store Picking
                  </h3>
                </div>
                <p className="text-xs sm:text-sm text-neutral-600 leading-relaxed">
                  Verified local merchants handpick fresh produce, inspect packaging, and pack delicate groceries securely for transit.
                </p>
                {/* Checklist */}
            ...
            <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-xs flex flex-col justify-between space-y-4">
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs text-neutral-700 pt-1">
                  ...
                  <div className="flex items-center gap-2">
                    <Check className="h-3.5 w-3.5 text-primary shrink-0" />
                    <span>WhatsApp & live tracking</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Check className="h-3.5 w-3.5 text-primary shrink-0" />
          ...
          {/* Personal Market Concierge Banner */}
          <div className="mt-8 rounded-2xl border border-primary/20 bg-gradient-to-r from-primary/[0.04] via-primary/[0.01] to-transparent p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="space-y-1 text-center sm:text-left">
              <span className="text-[11px] font-extrabold uppercase tracking-wider text-primary">
                New: Personal Market Shopper
              </span>
              <h3 className="text-base sm:text-lg font-bold text-neutral-900">
                Need fresh foodstuffs from Oke-Aje or Ita Osu Market?
              </h3>
              <p className="text-xs text-neutral-600 max-w-xl">
                Send a KingdomDash personal shopper with your exact checklist, inspection standards, and budget cap.
              </p>
            </div>
            <Button asChild variant="primary" className="rounded-xl font-bold text-white bg-primary hover:bg-primary-hover shrink-0">
        ...
        <PageContainer>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="rounded-2xl border border-neutral-200 bg-neutral-50/50 p-6 shadow-xs flex flex-col justify-between space-y-4 hover:border-neutral-300 transition-all">
              <div className="space-y-3">
                ...
                <div className="space-y-1.5 text-xs text-neutral-700 pt-1">
                  ...
                  <div className="flex items-center gap-2">
                    <Check className="h-3.5 w-3.5 text-primary shrink-0" />
                    <span>Secure parcel transit</span>
                  </div>
                </div>
              </div>
            ...
            <div className="rounded-2xl border border-neutral-200 bg-neutral-50/50 p-6 shadow-xs flex flex-col justify-between space-y-4 hover:border-neutral-300 transition-all">
              ...
              <div className="pt-2">
                <Button asChild variant="primary" className="w-full rounded-xl font-bold text-white bg-primary hover:bg-primary-hover">
                  <Link to="/business" className="text-white">Business Courier &amp; Volume Rates</Link>
                </Button>
              </div>
            </div>
          </div>
