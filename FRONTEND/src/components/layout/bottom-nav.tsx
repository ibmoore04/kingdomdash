...
const secondaryNavItems = [
  {
    ...
    to: '/business',
    icon: Building2,
    description: 'Corporate volume rates & bulk dispatch',
    badge: 'B2B',
  },
  {
    ...
    to: '/personal-shopper',
    icon: ShoppingBag,
    description: 'Market concierge for Oke-Aje & Ita Osu',
    badge: 'New',
  },
...
export function BottomNav() {
  ...
  const isMoreActive = ['/business', '/corporate', '/personal-shopper', '/shopper', '/about', '/services', '/contact'].some((path) =>
            ...
            <nav aria-label="Secondary navigation" className="p-2">
              <ul className="space-y-1">
                {secondaryNavItems.map((item) => {
                  const { label, to, icon: Icon, description } = item
                          ...
                          <div className="flex flex-col text-left">
                            <div className="flex items-center gap-1.5">
                              ...
                              {'badge' in item && item.badge && (
                                <span className="rounded-md bg-primary/15 px-1.5 py-0.2 text-[10px] font-bold text-primary">
                                  {item.badge}
                                </span>
                              )}
                            </div>
