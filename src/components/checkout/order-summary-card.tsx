...
import { Minus, Plus, Trash2, Info, ShieldCheck, Loader2 } from 'lucide-react'
...
export function OrderSummaryCard({
  ...
  const effectiveDeliveryFee = deliveryFee !== null ? deliveryFee : 0
  const grandTotal = subtotal + effectiveDeliveryFee + serviceFee
