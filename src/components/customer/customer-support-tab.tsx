...
export const CustomerSupportTab: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-border shadow-xs">
        <div>
          <h2 className="text-xl font-extrabold text-text-primary flex items-center gap-2">
            ...
            <span>Support Requests & Ticket Tracking</span>
          </h2>
          <p className="text-xs text-text-secondary mt-1">
            Track support tickets by Reference Code or review your submitted inquiries.
          </p>
        </div>
      ...
      {/* ── 1. REFERENCE NUMBER TRACKER SEARCH BOX ───────────────────────────────── */}
        ...
        {trackResult && (
          <div className="p-5 rounded-2xl bg-white border-2 border-primary/30 shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
              ...
              <div>
                <span className="text-text-muted block">Date Created:</span>
      ...
      {/* ── 2. MY SUBMITTED SUPPORT REQUESTS LIST ───────────────────────────────── */}
      <div className="bg-white rounded-2xl border border-border p-6 shadow-xs space-y-4">
        <div className="flex items-center justify-between border-b border-border pb-4">
          <h3 className="text-base font-bold text-text-primary">My Support History</h3>
          <Button
            variant="ghost"
            size="sm"
        ...
        {isLoading ? (
          ...
          <div className="py-12 text-center space-y-3">
            ...
            <div className="space-y-1">
              <p className="text-sm font-bold text-text-primary">No Support Tickets Logged</p>
              <p className="text-xs text-text-muted max-w-sm mx-auto">
                You haven&apos;t submitted any support requests with your account email yet.
              </p>
            </div>
