...
const BusinessPage = lazy(() => import('@/pages/public/business'))
const PersonalShopperPage = lazy(() => import('@/pages/public/personal-shopper'))
const PrivacyPage = lazy(() => import('@/pages/public/privacy'))
const TermsPage = lazy(() => import('@/pages/public/terms'))
const RefundPolicyPage = lazy(() => import('@/pages/public/refund-policy'))
  ...
  return (
    <>
      ...
      <Suspense fallback={<PageLoader />}>
        ...
        {/* ── Protected checkout & order confirmation — all authenticated users (customer, vendor, rider, admin) can purchase ── */}
        <Route element={<RouteGuard allowedRoles={['customer', 'vendor', 'rider', 'admin', 'super_admin']} />}>
        ...
        <Route element={<PublicLayout />}>
          ...
          <Route path="/shopper" element={<Navigate to="/personal-shopper" replace />} />
